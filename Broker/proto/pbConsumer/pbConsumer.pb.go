...
const file_Broker_proto_pbConsumer_proto_rawDesc = "" +
	...
	"\bConsumer\x12>\n" +
	"\fCheckIsAlive\x12\x11.pbConsumer.Empty\x1a\x1b.pbConsumer.IsAliveRespondeB\x0eZ\f./pbConsumerb\x06proto3"
...
var file_Broker_proto_pbConsumer_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_Broker_proto_pbConsumer_proto_goTypes = []any{
	(*Empty)(nil),           // 0: pbConsumer.Empty
	(*IsAliveResponde)(nil), // 1: pbConsumer.IsAliveResponde
}
var file_Broker_proto_pbConsumer_proto_depIdxs = []int32{
	0, // 0: pbConsumer.Consumer.CheckIsAlive:input_type -> pbConsumer.Empty
	1, // 1: pbConsumer.Consumer.CheckIsAlive:output_type -> pbConsumer.IsAliveResponde
