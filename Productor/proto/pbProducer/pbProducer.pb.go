...
// 	protoc        v7.34.1
// source: Productor/proto/pbProducer.proto
...
func (x *Empty) Reset() {
	*x = Empty{}
	mi := &file_Productor_proto_pbProducer_proto_msgTypes[0]
...
func (*Empty) Descriptor() ([]byte, []int) {
	return file_Productor_proto_pbProducer_proto_rawDescGZIP(), []int{0}
}
...
func (x *IsAliveResponde) Reset() {
	*x = IsAliveResponde{}
	mi := &file_Productor_proto_pbProducer_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IsAliveResponde) Descriptor() ([]byte, []int) {
	return file_Productor_proto_pbProducer_proto_rawDescGZIP(), []int{1}
}
...
func (x *PublishEventRequest) Reset() {
	*x = PublishEventRequest{}
	mi := &file_Productor_proto_pbProducer_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PublishEventRequest) Descriptor() ([]byte, []int) {
	return file_Productor_proto_pbProducer_proto_rawDescGZIP(), []int{2}
}
...
func (x *PublishEventResponse) Reset() {
	*x = PublishEventResponse{}
	mi := &file_Productor_proto_pbProducer_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PublishEventResponse) Descriptor() ([]byte, []int) {
	return file_Productor_proto_pbProducer_proto_rawDescGZIP(), []int{3}
}
...
var File_Productor_proto_pbProducer_proto protoreflect.FileDescriptor

const file_Productor_proto_pbProducer_proto_rawDesc = "" +
	"\n" +
	" Productor/proto/pbProducer.proto\x12\n" +
	"pbProducer\"\a\n" +
	"\x05Empty\"+\n" +
...
var (
	file_Productor_proto_pbProducer_proto_rawDescOnce sync.Once
	file_Productor_proto_pbProducer_proto_rawDescData []byte
)

func file_Productor_proto_pbProducer_proto_rawDescGZIP() []byte {
	file_Productor_proto_pbProducer_proto_rawDescOnce.Do(func() {
		file_Productor_proto_pbProducer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_Productor_proto_pbProducer_proto_rawDesc), len(file_Productor_proto_pbProducer_proto_rawDesc)))
	})
	return file_Productor_proto_pbProducer_proto_rawDescData
}

var file_Productor_proto_pbProducer_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_Productor_proto_pbProducer_proto_goTypes = []any{
...
var file_Productor_proto_pbProducer_proto_depIdxs = []int32{
...
func init() { file_Productor_proto_pbProducer_proto_init() }
func file_Productor_proto_pbProducer_proto_init() {
	if File_Productor_proto_pbProducer_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_Productor_proto_pbProducer_proto_rawDesc), len(file_Productor_proto_pbProducer_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_Productor_proto_pbProducer_proto_goTypes,
		DependencyIndexes: file_Productor_proto_pbProducer_proto_depIdxs,
		MessageInfos:      file_Productor_proto_pbProducer_proto_msgTypes,
	}.Build()
	File_Productor_proto_pbProducer_proto = out.File
	file_Productor_proto_pbProducer_proto_goTypes = nil
	file_Productor_proto_pbProducer_proto_depIdxs = nil
}
