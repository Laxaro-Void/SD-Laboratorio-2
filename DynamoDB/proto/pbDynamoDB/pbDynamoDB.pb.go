...
func (x *SyncAllDataResponse) Reset() {
	*x = SyncAllDataResponse{}
	mi := &file_DynamoDB_proto_pbDynamoDB_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SyncAllDataResponse) Descriptor() ([]byte, []int) {
	return file_DynamoDB_proto_pbDynamoDB_proto_rawDescGZIP(), []int{13}
}
...
func (x *GetAllDataResponse) Reset() {
	*x = GetAllDataResponse{}
	mi := &file_DynamoDB_proto_pbDynamoDB_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetAllDataResponse) Descriptor() ([]byte, []int) {
	return file_DynamoDB_proto_pbDynamoDB_proto_rawDescGZIP(), []int{14}
}
...
var file_DynamoDB_proto_pbDynamoDB_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
