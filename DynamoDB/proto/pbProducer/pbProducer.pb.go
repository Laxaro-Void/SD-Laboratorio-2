...
// 	protoc        v7.35.0
// source: DynamoDB/proto/pbProducer.proto
...
func (x *Empty) Reset() {
	*x = Empty{}
	mi := &file_DynamoDB_proto_pbProducer_proto_msgTypes[0]
...
func (*Empty) Descriptor() ([]byte, []int) {
	return file_DynamoDB_proto_pbProducer_proto_rawDescGZIP(), []int{0}
}
...
func (x *IsAliveResponde) Reset() {
	*x = IsAliveResponde{}
	mi := &file_DynamoDB_proto_pbProducer_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IsAliveResponde) Descriptor() ([]byte, []int) {
	return file_DynamoDB_proto_pbProducer_proto_rawDescGZIP(), []int{1}
}
...
func (x *PublishEventRequest) Reset() {
	*x = PublishEventRequest{}
	mi := &file_DynamoDB_proto_pbProducer_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PublishEventRequest) Descriptor() ([]byte, []int) {
	return file_DynamoDB_proto_pbProducer_proto_rawDescGZIP(), []int{2}
}
...
func (x *PublishEventResponse) Reset() {
	*x = PublishEventResponse{}
	mi := &file_DynamoDB_proto_pbProducer_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PublishEventResponse) Descriptor() ([]byte, []int) {
	return file_DynamoDB_proto_pbProducer_proto_rawDescGZIP(), []int{3}
}
...
var File_DynamoDB_proto_pbProducer_proto protoreflect.FileDescriptor

const file_DynamoDB_proto_pbProducer_proto_rawDesc = "" +
	"\n" +
	"\x1fDynamoDB/proto/pbProducer.proto\x12\n" +
	"pbProducer\"\a\n" +
	"\x05Empty\"+\n" +
	"\x0fIsAliveResponde\x12\x18\n" +
	"\aisAlive\x18\x01 \x01(\bR\aisAlive\"\x90\x02\n" +
...
var (
	file_DynamoDB_proto_pbProducer_proto_rawDescOnce sync.Once
	file_DynamoDB_proto_pbProducer_proto_rawDescData []byte
)

func file_DynamoDB_proto_pbProducer_proto_rawDescGZIP() []byte {
	file_DynamoDB_proto_pbProducer_proto_rawDescOnce.Do(func() {
		file_DynamoDB_proto_pbProducer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_DynamoDB_proto_pbProducer_proto_rawDesc), len(file_DynamoDB_proto_pbProducer_proto_rawDesc)))
	})
	return file_DynamoDB_proto_pbProducer_proto_rawDescData
}

var file_DynamoDB_proto_pbProducer_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_DynamoDB_proto_pbProducer_proto_goTypes = []any{
...
var file_DynamoDB_proto_pbProducer_proto_depIdxs = []int32{
...
func init() { file_DynamoDB_proto_pbProducer_proto_init() }
func file_DynamoDB_proto_pbProducer_proto_init() {
	if File_DynamoDB_proto_pbProducer_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_DynamoDB_proto_pbProducer_proto_rawDesc), len(file_DynamoDB_proto_pbProducer_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_DynamoDB_proto_pbProducer_proto_goTypes,
		DependencyIndexes: file_DynamoDB_proto_pbProducer_proto_depIdxs,
		MessageInfos:      file_DynamoDB_proto_pbProducer_proto_msgTypes,
	}.Build()
	File_DynamoDB_proto_pbProducer_proto = out.File
	file_DynamoDB_proto_pbProducer_proto_goTypes = nil
	file_DynamoDB_proto_pbProducer_proto_depIdxs = nil
}
